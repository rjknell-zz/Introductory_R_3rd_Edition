...
This isn't necessarily a good thing: for example, we might not want the `Experimenter` column to be classed as a factor. We can change it back to character data using `as.character()`, like this:
