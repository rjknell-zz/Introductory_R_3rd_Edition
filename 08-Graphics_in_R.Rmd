# R graphics I — drawing graphs and changing plot symbols and colours using the base graphics system
...
Haemocyte <-
  read.table("http://www.introductoryR.co.uk/Haemocyte.txt", header = TRUE)

tbdata <-
  read.table("http://www.introductoryR.co.uk/TB_HPA.txt", header = TRUE)

whale2 <-
  read.table("http://www.introductoryr.co.uk/Whale%20brain%20dive%20data.txt",
             header = TRUE)
earwig <-
  read.table("http://www.introductoryR.co.uk/earwig.txt", header = TRUE)

IMH<-read.table("http://www.introductoryr.co.uk/IMH2012.txt", header = TRUE)
```
