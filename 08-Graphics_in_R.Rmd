...
earwig <-
  read.table("http://www.introductoryR.co.uk/earwig.txt", header = TRUE)
...
```{r}
pinniped <- read.csv("http://www.introductoryr.co.uk/Pinniped_brains.csv", stringsAsFactors = FALSE)
```
...
```{r}
IMH<-read.table("http://www.introductoryr.co.uk/IMH2012.txt")
str(IMH)
```
