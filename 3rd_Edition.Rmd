...
<!--chapter:end:01_First_R_Session.Rmd-->
...
<!--chapter:end:04-Subscripts_and_subsetting.Rmd-->
...
<!--chapter:end:05-Writing_and_using_R_scripts.Rmd-->
...
<!--chapter:end:07-Importing_data.Rmd-->

# R graphics I — basic graphcs, colours and plot symbols
...
Haemocyte <-
  read.table("https://github.com/rjknell/Introductory_R_3rd_Edition/raw/master/Data/Haemocyte.txt", header = TRUE)

tbdata <-
  read.table("https://github.com/rjknell/Introductory_R_3rd_Edition/raw/master/Data/TB_HPA.txt", header = TRUE)

earwig <-
  read.table("https://github.com/rjknell/Introductory_R_3rd_Edition/raw/master/Data/earwig.txt", header = TRUE)

IMH<-read.table("https://github.com/rjknell/Introductory_R_3rd_Edition/raw/master/Data/IMH2012.txt", header = TRUE)
```
...
UFO <- read.csv("https://github.com/rjknell/Introductory_R_3rd_Edition/raw/master/Data/UFO_data.csv",
...
```{r}
pinniped <- read.csv("https://github.com/rjknell/Introductory_R_3rd_Edition/raw/master/Data/Pinniped_brains.csv")
```
...
WB <- read.csv("https://github.com/rjknell/Introductory_R_3rd_Edition/raw/master/Data/World_bank_data_2014.csv")
...
```{r}
IMH<-read.table("https://github.com/rjknell/Introductory_R_3rd_Edition/raw/master/Data/IMH2012.txt")
str(IMH)
```
...
<!--chapter:end:08-Graphics_in_R.Rmd-->


# R graphics II — Adding elements to an existing graph
...
<!--chapter:end:09-Graphics_in_R_2.Rmd-->
...
<!--chapter:end:11-Basic_stats.Rmd-->
...
<!--chapter:end:12-Statistical_testing.Rmd-->
...
<!--chapter:end:15-Correlation.Rmd-->
...
<!--chapter:end:16-TB_Regression.Rmd-->
...
<!--chapter:end:18-Two_factor_ANOVA.Rmd-->
